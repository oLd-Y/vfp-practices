...
FOR i = 1 TO 80000
    ...
    * if a student has multiple volunteer, then the university code should be different
    ...
    FOR j = 1 TO m.vol_num
        ...
        DO WHILE j == 3
            ...
            IF m.volu_code1 == m.volu_code2 .OR. m.volu_code2 == m.volu_code3 .OR. m.volu_code1 == m.volu_code3
                LOOP
            ENDIF
            EXIT
        ENDDO
    ...
    * generate a random pass number and id card number
    ...
    DO WHILE .T.
        ...
        IF SEEK(m.pass_num, "student", "pass_num") .OR. SEEK(m.pass_num, "student", "pass_num")
            LOOP
        ENDIF
        SET ORDER TO
        EXIT
